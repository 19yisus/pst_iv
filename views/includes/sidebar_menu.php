        ...
        $watch('selected', value => localStorage.setItem('selected', JSON.stringify(value)))">
					...
					<div>
						...
						<ul class="mb-6 flex flex-col gap-1.5">
							...
							<li>
								<a class="group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4" href="<?php $this->SetURL('inicio/'); ?>" @click="selected = (selected === 'inicio' ? '':'inicio')" :class="{ 'bg-graydark dark:bg-meta-4': (selected === 'inicio') && (page === 'inicio	') }">
							...
							if ($_SESSION['permisos'] == '1' && $_SESSION['update_required'] === false) { ?>
								<!-- Menu Item Calendar -->
								<li>
									<a class="group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4" href="<?php $this->SetURL('carrera/'); ?>" @click="selected = (selected === 'carrera' ? '':'carrera')" :class="{ 'bg-graydark dark:bg-meta-4': (selected === 'carrera') && (page === 'carrera') }">
										<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-diamond-fill" viewBox="0 0 16 16">
											<path fill-rule="evenodd" d="M6.95.435c.58-.58 1.52-.58 2.1 0l6.515 6.516c.58.58.58 1.519 0 2.098L9.05 15.565c-.58.58-1.519.58-2.098 0L.435 9.05a1.482 1.482 0 0 1 0-2.098L6.95.435z" />
										</svg>
										Carreras
								...
								<!-- Menu Item Calendar -->
								<li>
									<a class="group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4" href="<?php $this->SetURL('seccion/'); ?>" @click="selected = (selected === 'seccion' ? '':'seccion')" :class="{ 'bg-graydark dark:bg-meta-4': (selected === 'seccion') && (page === 'seccion') }">
								...
								<!-- Menu Item Calendar -->
								<li>
									<a class="group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4" href="<?php $this->SetURL('lapso-academico/'); ?>" @click="selected = (selected === 'lapso-academico' ? '':'lapso-academico')" :class="{ 'bg-graydark dark:bg-meta-4': (selected === 'lapso-academico') && (page === 'lapso-academico') }">
								...
								<!-- Menu Item Calendar -->
								<li>
									<a class="group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4" href="<?php $this->SetURL('estudiante/'); ?>" @click="selected = (selected === 'estudiante' ? '':'estudiante')" :class="{ 'bg-graydark dark:bg-meta-4': (selected === 'estudiante') && (page === 'estudiante') }">
								...
								<!-- Menu Item Calendar -->
								<li>
									<a class="group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4" href="<?php $this->SetURL('grupo/'); ?>" @click="selected = (selected === 'grupo' ? '':'grupo')" :class="{ 'bg-graydark dark:bg-meta-4': (selected === 'grupo') && (page === 'grupo') }">
								...
								<!-- Menu Item Calendar -->
								<li>
									<a class="group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4" href="<?php $this->SetURL('tutor/'); ?>" @click="selected = (selected === 'tutor' ? '':'tutor')" :class="{ 'bg-graydark dark:bg-meta-4': (selected === 'tutor') && (page === 'tutor') }">
								...
								<!-- Menu Item Calendar -->
								<li>
									<a class="group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4" href="<?php $this->SetURL('bitacora/'); ?>" @click="selected = (selected === 'tutor' ? '':'tutor')" :class="{ 'bg-graydark dark:bg-meta-4': (selected === 'tutor') && (page === 'tutor') }">
										<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-vcard-fill" viewBox="0 0 16 16">
											<path d="M0 4a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V4Zm9 1.5a.5.5 0 0 0 .5.5h4a.5.5 0 0 0 0-1h-4a.5.5 0 0 0-.5.5ZM9 8a.5.5 0 0 0 .5.5h4a.5.5 0 0 0 0-1h-4A.5.5 0 0 0 9 8Zm1 2.5a.5.5 0 0 0 .5.5h3a.5.5 0 0 0 0-1h-3a.5.5 0 0 0-.5.5Zm-1 2C9 10.567 7.21 9 5 9c-2.086 0-3.8 1.398-3.984 3.181A1 1 0 0 0 2 13h6.96c.026-.163.04-.33.04-.5ZM7 6a2 2 0 1 0-4 0 2 2 0 0 0 4 0Z" />
										</svg>
								...
								<!-- Menu Item Calendar -->
								<li>
									<a class="group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4" href="<?php $this->SetURL('tutor-comunidad/'); ?>" @click="selected = (selected === 'tutor-comunidad' ? '':'tutor-comunidad')" :class="{ 'bg-graydark dark:bg-meta-4': (selected === 'tutor-comunidad') && (page === 'tutor-comunidad') }">
