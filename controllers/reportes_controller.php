<?php
  ...
  function rp_inscripcion($datos){
    ...
    $pdf->cell(190, 5, utf8_decode("VICERECTORADO ACADÉMICO"),0,1,"C",0);
    ...
    $pdf->ln(8);
    $pdf->cell(95, 5, utf8_decode("NÚMERO DE CONTROL: ______________________"),0,0,"L");
    $pdf->cell(95, 5, "FECHA ____/_____/_______",0,1,"R",0);
    $pdf->ln(10);
    $pdf->cell(95, 5, utf8_decode("NÚCLEO:______________________"),0,0,"L");
    $pdf->cell(95, 5, "EMISION:_______________________",0,1,"R",0);
    $pdf->ln(10);
    $pdf->setFont('Arial', 'B', 12);
    $pdf->cell(190, 5, utf8_decode("PLANILLA DE INSCRIPCIÓN AL SERVICIO COMUNITARIO"),0,1,"C",0);
    $pdf->setFont('Arial', '', 9);
    $pdf->cell(190, 5, "1. Datos de los preestadores del servicio comunitario:",0,1,"C",0);
    $pdf->ln(5);
    $pdf->setFont('Arial', '', 7);
    $pdf->cell(3, 5, "N",1,0,"C");
    $pdf->cell(49, 5, "APELLIDOS Y NOMBRES",1,0,"C");
    $pdf->cell(12, 5, utf8_decode("CÉDULA"),1,0,"C");
    $pdf->cell(19, 5, utf8_decode("TELÉFONO"),1,0,"C");
    $pdf->cell(45, 5, "CORREO ELECTRONICO",1,0,"C");
    ...
    for($i = 0; $i < 7; $i++){
      ...
      $pdf->cell(49, 10, utf8_decode($nombre),1,0,"C");
      $pdf->cell(12, 10, utf8_decode($cedula),1,0,"C");
      $pdf->cell(19, 10, utf8_decode($telefono),1,0,"C");
      $pdf->cell(45, 10, utf8_decode($correo),1,0,"C");
      $pdf->setFont('Arial', '', 5);
    ...
    $pdf->ln(5);
    $pdf->setFont('Arial', '', 9);
    $pdf->cell(190, 5, utf8_decode("2. Datos de la comunidad / Institución:"),0,1,"C",0);
    $pdf->setFont('Arial', '', 8);
    $pdf->cell(73, 5, "NOMBRE DE LA COMUNIDAD",1,0,"C");
    $pdf->cell(46, 5, utf8_decode("DIRECCIÓN"),1,0,"C");
    $pdf->cell(39, 5, "RESPONSABLE",1,0,"C");
    $pdf->cell(14, 5, utf8_decode("CÉDULA"),1,0,"C");
    $pdf->cell(18, 5, utf8_decode("TELÉFONO"),1,1,"C");
    $pdf->setFont('Arial', '', 5);
    ...
    $pdf->setFont('Arial', '', 7);
    $pdf->cell(39, 15, utf8_decode($d_proyecto['nombre_tutor_comunidad']),1,0,"C");
    $pdf->cell(14, 15, utf8_decode($d_proyecto['cedula_tutor']),1,0,"C");
    $pdf->cell(18, 15, utf8_decode($d_proyecto['telefono_tutor']),1,1,"C");
